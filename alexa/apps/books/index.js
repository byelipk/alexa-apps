...
app.launch(function(req, res) {
  res
    ...
    .reprompt("Please say get book, followed by the title.")
...
app.intent(
  ...
  {
    slots: {},
    utterances: ["{abort|transaction complete|finalize}"]
  },
  function(req, res) {
    res.say("Goodbye.").shouldEndSession(true);
  }
...
app.intent(
  ...
  function(req, res) {
    message =
      "I can tell you details about books from GoodReads. To find a book,\
...
app.intent(
  ...
  function(req, res) {
    res
      .say("Please say get book, followed by the title.")
      .shouldEndSession(false);
  }
);
